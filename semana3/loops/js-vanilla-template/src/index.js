...
enquanto a variavel "i" for menor que 5 ele vai somar com a variavel "valor"
...
a. os numeros maiores que 18 da varivavel "lista"
...
let arrayOriginal = [80, 30, 130, 40, 60, 21, 70, 120, 90, 103, 110, 55]
let novoArray = []
    for (let numeroPar = 0; numeroPar < arrayOriginal.length; numeroPar++){
        if (arrayOriginal[numeroPar] % 2 === 0){
            novoArray.push(arrayOriginal[numeroPar])
        }
    }
...
let maiorNumero = arrayOriginal[0];
    for (let numero = 0; numero < arrayOriginal.length; numero++){
        if(arrayOriginal[numero] > maiorNumero){
            maiorNumero = arrayOriginal[numero]
        } else if(arrayOriginal[numero] < menorNumero){
            menorNumero = arrayOriginal[numero]
        }
}
    console.log('O maior numero é ', maiorNumero, ' e menor numero é ', menorNumero) 
*/